...
static PyObject *impl_PIL$ImageQt$$$function__6__toqclass_helper(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_args_element_value_7 = impl___main__$$$function__7_complex_call_helper_star_list(tstate, dir_call_args);
        }
...
static function_impl_code const function_table_PIL$ImageQt[] = {
    impl_PIL$ImageQt$$$function__6__toqclass_helper$$$function__1_lambda,
    impl_PIL$ImageQt$$$function__1_lambda,
    impl_PIL$ImageQt$$$function__2_rgb,
    impl_PIL$ImageQt$$$function__3_fromqimage,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_PIL$ImageQt);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_PIL$ImageQt,
        sizeof(function_table_PIL$ImageQt) / sizeof(function_impl_code)
    );
}
