...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("numpy.typing._nbit"));
...
static PyCodeObject *codeobj_2d3eaba936fb8c721d229dc5eb4b53b5;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[19]); CHECK_OBJECT(module_filename_obj);
    codeobj_2d3eaba936fb8c721d229dc5eb4b53b5 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[20], mod_consts[20], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_2d3eaba936fb8c721d229dc5eb4b53b5;
    ...
    frame_2d3eaba936fb8c721d229dc5eb4b53b5 = MAKE_MODULE_FRAME(codeobj_2d3eaba936fb8c721d229dc5eb4b53b5, module_numpy$typing$_nbit);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_2d3eaba936fb8c721d229dc5eb4b53b5);
    assert(Py_REFCNT(frame_2d3eaba936fb8c721d229dc5eb4b53b5) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_2d3eaba936fb8c721d229dc5eb4b53b5, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_2d3eaba936fb8c721d229dc5eb4b53b5->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_2d3eaba936fb8c721d229dc5eb4b53b5, exception_lineno);
    }



    assertFrameObject(frame_2d3eaba936fb8c721d229dc5eb4b53b5);
